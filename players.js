		  ...
		  for(i = 0; i < phpResponse.length; i++) {
			  ...
			  if(phpResponse[i]["homeaway"]=="home") {
			  	...
			  	if(phpResponse[i]["fantasyPoints"] == null) {
			  		$('#standingsTable').append('<tr class="filteredResults"><td class="standingsTableRow rankColumn stickyColumnRank" style="padding-left: 10px" id="sticky2Rank">'+(i+1)+'</td><td class="standingsTableRow teamColumn stickyColumn" style="padding-left: 10px" id="sticky2">'+phpResponse[i]["playerName"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["team"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["opponent"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["position"]+'</td><td class="standingsTableRow otherColumn">'+'0</td></tr>');			  
			  	}
				else {
					$('#standingsTable').append('<tr class="filteredResults"><td class="standingsTableRow rankColumn stickyColumnRank" style="padding-left: 10px" id="sticky2Rank">'+(i+1)+'</td><td class="standingsTableRow teamColumn stickyColumn" style="padding-left: 10px" id="sticky2">'+phpResponse[i]["playerName"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["team"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["opponent"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["position"]+'</td><td class="standingsTableRow otherColumn">'+phpResponse[i]["fantasyPoints"]+'</td></tr>');			  
				}
			  }
