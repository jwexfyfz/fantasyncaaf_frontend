		...
		-->
			...
			<div class="filters">
				<table class="headerTable" id="headerTable">
					...
					<tr class="filterRows">
						<td class="positionFilterCell" id="QBpositionFilterCell"><div class="filterButton" id="QBfilter" data-enabled="true" onClick="filterClick(this.id)">QB</div></td>
						<td class="positionFilterCell" id="RBpositionFilterCell"><div class="filterButton" id="RBfilter" data-enabled="true" onClick="filterClick(this.id)">RB</div></td>
						<td class="positionFilterCell" id="WRpositionFilterCell"><div class="filterButton" id="WRfilter" data-enabled="true" onClick="filterClick(this.id)">WR</div></td>
					</tr>
					<tr class="filterRows">
						<td class="positionFilterCell" id="TEpositionFilterCell"><div class="filterButton" id="TEfilter" data-enabled="true" onClick="filterClick(this.id)">TE</div></td>
						<td class="positionFilterCell" id="DEFpositionFilterCell"><div class="filterButton" id="DEFfilter" data-enabled="true" onClick="filterClick(this.id)">DEF</div></td>
						<td class="positionFilterCell" id="KpositionFilterCell"><div class="filterButton" id="Kfilter" data-enabled="true" onClick="filterClick(this.id)">K</div></td>
					</tr>
				</table>
			</div>
